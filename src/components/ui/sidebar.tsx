        ...
        return (
          <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
            ...
            >
              ...
              <div className="flex h-full w-full flex-col bg-sidebar border border-sidebar-border rounded-xl overflow-y-auto shadow-lg">{children}</div>
            </SheetContent>
          </Sheet>
        )
      }
...
>(({ className, asChild = false, tooltip, ...props }, ref) => {
  ...
  const button = (
    <Comp
      ...
      data-sidebar="toggle"
      className={cn(
        "hidden md:flex h-9 w-9 items-center justify-center text-sidebar-foreground rounded-md hover:bg-sidebar-accent transition-colors",
        className
      )}
    ...
    >
      <Icon
        className={cn(
          "shrink-0 text-sidebar-foreground/70 transition-all hover:text-sidebar-foreground size-4"
        )}
      />
    </Comp>
  )
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button relative flex w-full items-center overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all duration-200 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-primary/15 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[state=collapsed]/sidebar-wrapper:justify-center group-data-[state=collapsed]/sidebar-wrapper:px-2 group-data-[state=expanded]/sidebar-wrapper:gap-3 [&>span:last-child]:group-data-[state=collapsed]/sidebar-wrapper:opacity-0 [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0 [&>svg]:group-data-[state=collapsed]/sidebar-wrapper:mx-auto data-[active=true]:bg-gradient-to-r data-[active=true]:from-primary/15 data-[active=true]:to-transparent data-[active=true]:text-primary data-[active=true]:font-medium data-[active=true]:border-l-2 data-[active=true]:border-primary data-[active=true]:shadow-[inset_0_1px_2px_0_rgba(0,0,0,0.05)]",
  {
    variants: {
      variant: {
