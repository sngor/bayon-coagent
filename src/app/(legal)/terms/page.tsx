    ...
    return (
        <div className="container max-w-4xl py-12 px-4">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
                ...
                <section>
                    <h2 className="font-headline text-2xl font-semibold mb-4">2. Description of Service</h2>
                    <p className="mb-4">
                ...
                <section>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">3.1 Account Creation</h3>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">3.2 Account Responsibility</h3>
                    <p>
                ...
                <section>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">4.1 Permitted Use</h3>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">4.2 Prohibited Use</h3>
                ...
                <section>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">5.1 Your Content</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">5.2 Our Platform</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">5.3 AI-Generated Content</h3>
                    <p>
                ...
                <section className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-6 border border-blue-200 dark:border-blue-900">
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">6.1 Fees</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">6.2 Automatic Renewal</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">6.3 Price Changes</h3>
                    <p>
                        We may change our pricing with 30 days' notice. Continued use after the price change constitutes acceptance.
                    </p>

                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">6.4 Cancellation</h3>
                    <p>
                ...
                <section>
                    <h2 className="font-headline text-2xl font-semibold mb-4">7. Third-Party Services</h2>
                    <p className="mb-4">
                ...
                <section className="bg-yellow-50 dark:bg-yellow-950/20 rounded-lg p-6 border border-yellow-200 dark:border-yellow-900">
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">8.1 Service Availability</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">8.2 AI Accuracy</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">8.3 Professional Advice</h3>
                    <p>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">8.4 Limitation of Liability</h3>
                    <p>
                ...
                <section>
                    <h2 className="font-headline text-2xl font-semibold mb-4">10. Termination</h2>
                    <p className="mb-4">
                ...
                <section>
                    <h2 className="font-headline text-2xl font-semibold mb-4">11. Data and Privacy</h2>
                    <p>
                ...
                <section>
                    ...
                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">12.1 Governing Law</h3>
                    <p>
                        These Terms are governed by the laws of [Your Jurisdiction], without regard to conflict of law principles.
                    </p>

                    <h3 className="font-headline text-xl font-semibold mb-3 mt-6">12.2 Arbitration</h3>
                    <p>
                ...
                <section>
                    <h2 className="font-headline text-2xl font-semibold mb-4">14. Miscellaneous</h2>
                    <ul className="list-disc pl-6 space-y-2">
