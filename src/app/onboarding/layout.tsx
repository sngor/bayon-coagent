...
/**
 * Onboarding Layout (Temporary Fix)
 * 
 * Provides a minimal layout for the onboarding flow without the main app sidebar.
 * This is a temporary workaround for the route group issue.
 * 
 * Note: This replaces the (onboarding) route group until the routing issue is resolved.
 */
