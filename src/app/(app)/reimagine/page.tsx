                                ...
                                <div className="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <div className="text-center">
                                        <h3 className="font-headline font-semibold text-lg mb-1">
                                            {activeEdit?.editType === 'virtual-staging' ? 'Staging your room...' :
                                                activeEdit?.editType === 'day-to-dusk' ? 'Transforming to golden hour...' :
                                                    activeEdit?.editType === 'enhance' ? 'Enhancing your image...' :
                                                        activeEdit?.editType === 'item-removal' ? 'Removing unwanted items...' :
                                                            activeEdit?.editType === 'virtual-renovation' ? 'Visualizing your renovation...' :
