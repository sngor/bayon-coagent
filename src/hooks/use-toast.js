...
exports.TOAST_DURATION = exports.reducer = void 0;
...
exports.showAIToast = showAIToast;
...
function toast({ duration = TOAST_DURATION.DEFAULT, ...props }) {
    const id = genId();
...
function showAIToast(title, description) {
    return toast({
        title,
        description,
        variant: "ai",
...
function showPersistentToast(title, description, variant = "default") {
    return toast({
        title,
        description,
        variant,
